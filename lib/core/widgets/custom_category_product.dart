...
class CustomCategoryProduct extends StatelessWidget {
  const CustomCategoryProduct({
    super.key, this.onTapFavorite, this.onTapCartAdd,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(product.name, textAlign: TextAlign.end,style: TextStyles.semiBold13.copyWith(color: AppColor.grayscale950),),
                        const SizedBox(height: 4,),
                        Row(
                          children: [
                            Text("${product.price}جنية/",textAlign: TextAlign.end, style: TextStyles.bold13.copyWith(color: AppColor.orange500),),
